...
Participation.create(speaker_id: 1, event_id: 1)
Participation.create(speaker_id: 2, event_id: 1)
...
Participation.create(speaker_id: 3, event_id: 2)
...
Participation.create(speaker_id: 4, event_id: 3)
...
Participation.create(speaker_id: 5, event_id: 4)
...
Participation.create(speaker_id: 6, event_id: 5)
